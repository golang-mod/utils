...
//// 请填写您的AccessKeyId。
//var accessKeyId = env.Env.Alioss.AccessKeyId
//
//// 请填写您的AccessKeySecret。
//var accessKeySecret = env.Env.Alioss.AccessKeySecret
//
//// host的格式为 bucketname.endpoint ，请替换为您的真实信息。
//var host = env.Env.Alioss.EndpointUrl
//
//// callbackUrl为 上传回调服务器的URL，请将下面的IP和Port配置为您自己的真实信息。
//var callbackUrl = env.Env.Alioss.CallbackUrl
